        ...
        <ul class="list-unstyled" style="">
            ...
            <div class="row" style="margin-left: 0; ">
                <div class="" v-for="(item, index) in media" :key="index" style="margin-top: 0; margin-bottom: 0.5em">
                    <div class="card h-100" style="width: 95px; margin-right: 0.2em; padding-bottom: 0.2em" >
                        <h5 class="card-subtitle" style="font-size: 11px; margin: 0.5em"><strong>{{ item.filename | truncate(8, '..') }}</strong></h5>
